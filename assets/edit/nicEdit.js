...
var nicEditorConfig = bkClass.extend({
	buttons : {
		...
		'left' : {name : __('居左'), command : 'justifyleft', noActive : true},
		'center' : {name : __('居中'), command : 'justifycenter', noActive : true},
		'right' : {name : __('居右'), command : 'justifyright', noActive : true},
		'justify' : {name : __('两端'), command : 'justifyfull', noActive : true},
		'ol' : {name : __('序列'), command : 'insertorderedlist', tags : ['OL']},
		'ul' : 	{name : __('列表'), command : 'insertunorderedlist', tags : ['UL']},
	...
	buttonList : ['save','bold','italic','underline','strikethrough','left','center','right','justify','ol','ul','fontSize','fontFamily','fontFormat','indent','outdent','image','upload','link','unlink','forecolor','bgcolor'],
	iconList : {"xhtml":1,"bgcolor":2,"forecolor":3,"bold":4,"center":5,"hr":6,"indent":7,"italic":8,"justify":9,"left":10,"ol":11,"outdent":12,"removeformat":13,"right":14,"save":15,"strikethrough":16,"subscript":17,"superscript":18,"ul":19,"underline":20,"image":21,"link":22,"unlink":23,"close":24,"arrow":25,"upload":26,"test":26}
...
var nicColorOptions = {
	buttons : {
		'forecolor' : {name : __('字体颜色'), type : 'nicEditorColorButton', noClose : true},
...
var nicImageOptions = {
	buttons : {
		'image' : {name : '网络图片', type : 'nicImageButton', tags : ['IMG']}
	}
	
};

var nicImageButton=nicEditorAdvancedButton.extend({addPane:function(){this.im=this.ne.selectedInstance.selElm().parentTag("IMG");this.addForm({"":{type:"title",txt:"添加/编辑 图片"},src:{type:"text",txt:"地址:",value:"http://",style:{width:"150px"}},alt:{type:"text",txt:"描述:",style:{width:"100px"}},align:{type:"select",txt:"对齐:",options:{none:"Default",left:"Left",right:"Right"}}},this.im)},submit:function(B){var C=this.inputs.src.value;if(C==""||C=="http://"){alert("You must enter a Image URL to insert");return false}this.removePane();if(!this.im){var A="javascript:nicImTemp();";this.ne.nicCommand("insertImage",A);this.im=this.findElm("IMG","src",A)}if(this.im){this.im.setAttributes({src:this.inputs.src.value,alt:this.inputs.alt.value,align:this.inputs.align.value})}}});nicEditors.registerPlugin(nicPlugin,nicImageOptions);
...
var nicUploadButton = nicEditorAdvancedButton.extend({
	nicURI: "app/class/upload.asp",
	errorText: "上传图片失败！",
	addPane: function() {
		if (typeof window.FormData === "undefined") {
			return this.onError("该浏览器不支持, 请使用： Chrome, Firefox, or Safari.")
		}
	...
	uploadFile: function() {
		...
		C.open("POST", this.ne.options.uploadURI || this.nicURI + '?t=' + B.type);
		C.onload = function() {
			try {
